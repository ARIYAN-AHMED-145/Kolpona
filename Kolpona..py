...
#__________Appvl___________#
def Subscraption():
	os.system('xdg-open https://www.facebook.com/Ariyan.of.king143')
	niloy = str(os.geteuid())
	rohan = str(os.geteuid())
	ariyan = (niloy+rohan)
	arif = (f'SUYAIB-{ariyan}') 
	clear()
	print(logo)
	r1=requests.get("https://github.com/ARIYAN-AHMED-145/Appvl/blob/main/Approvel").text
	if 'Ariyan' in r1:
		os.system('clear')
		print(logo)
		main()
		...
		print(logo)
		print ("")
		print(" \033[1;32m PREMIUM TROLL  NEED GET APPROVED FIRST\033[1;37m\n")
		print(" \033[1;32m Note : AT FIRST COPY YOUR KEY SENT ADMIN FOR APPROVED...  \033[1;37m")
		print ("")
		print(" Your Key is Not Approved ")
		print("")
		print(" Copy And Send Key To Admin")
		print ("")
		print (" Your Key : "+ariyan)
		print ("")
